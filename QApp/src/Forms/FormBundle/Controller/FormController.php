...
class FormController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('FormsFormBundle:Form')->findAll();
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('FormsFormBundle:Form')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("FormsFormBundle:Form:edit.html.twig")
     */
