...
use Forms\FormsBundle\Entity\FormCategory;
use Forms\FormsBundle\Form\FormCategoryType;
...
class FormCategoryController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('FormsFormsBundle:FormCategory')->findAll();
     ...
     * @Method("POST")
     * @Template("FormsFormsBundle:FormCategory:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('FormsFormsBundle:FormCategory')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("FormsFormsBundle:FormCategory:edit.html.twig")
     */
