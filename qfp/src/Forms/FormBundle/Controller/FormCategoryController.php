...
namespace Forms\FormBundle\Controller;
...
use Forms\FormBundle\Entity\FormCategory;
use Forms\FormBundle\Form\FormCategoryType;
...
class FormCategoryController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('FormsFormBundle:FormCategory')->findAll();
     ...
     * @Method("POST")
     * @Template("FormsFormBundle:FormCategory:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('FormsFormBundle:FormCategory')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("FormsFormBundle:FormCategory:edit.html.twig")
     */
